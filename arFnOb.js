...
// ৬. তুমি কি একটা শর্ত পালন করলে একটা কিছু করবে। শর্ত পূরণ না করলে অন্য কিছু একটা করবে এমন কোড লিখতে পারবে। অর্থাৎ তুমি কি if-else এর কোড লিখতে পারবে। পারলে একটা কোড লিখে ফেলো 
        ...
        if(x!=y && x>y){
            // console.log("10 != 5 and 10 > 5");
        } else if (x==y || x<y ) {
            // console.log("1 con true");
        }
        else{
            // console.log("False");
        }
...
let numbers = [12, 15, 20, 25, 30, 34, 35];
...
let numberArray = [12, 15, 90, 25, 300, 34, 35, 94, 18];
...
const feetResult =feetToInch(5);
// console.log(feetResult ,"Inch");  
...
const totalBookPage = paperRequirements(4,10,6);
// console.log(totalBookPage, "Total pages");
...
let names =["rafiq", "kamal hossain","Md. abu", "jamal uddin sekh kamal", "mostafa mahamud shovon", "abu hena mostafa "];
...
// ৫. এইটা একটু ট্রিকি হতে পারে। একটা array এর মধ্যে অনেকগুলা সংখ্যা থাকবে। তোমার কাজ হচ্ছে সংখ্যা গুলা একটার পর একটা করে চেক করা। এবং সংখ্যা গুলা যদি পজিটিভ সংখ্যা হয়। অর্থাৎ শূন্য বা শূন্যের চাইতে বড় হয় তাহলে সেগুলাকে কোন একটা array এর মধ্যে রাখবে। আর যদি নেগেটিভ সংখ্যা হয়। তাহলে লুপটা স্টপ করে দিবে। এবং লুপ বন্ধ করার আগ পর্যন্ত যতগুলা পজিটিভ সংখ্যা পাওয়া গেছে। সেগুলা রিটার্ন করে দিবে। 
 ...
 const numberArr =[12, 4, 54, 88, 0, 92, 22, 34, 0, 43, -29];

const allPositive = positiveNumber(numberArr);
